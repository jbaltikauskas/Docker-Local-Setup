function Get-MSSqlStartScriptTemplate () {
    <#
    .SYNOPSIS
...
<#
.SYNOPSIS
    Starts this MSSQL Server Docker stack.
.DESCRIPTION
...
.INPUTS
    None.
.OUTPUTS
    Docker Compose status and connection string.
.NOTES
...
try {
    ...
    Write-Host "Connection: __CONNECTION_STRING__" -ForegroundColor Cyan
}
catch {
    Write-Error $_
    exit 1
